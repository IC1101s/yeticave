...
$user_name = 'Stanislav'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <?php if ($isFlatpickr): ?><link href="../css/flatpickr.min.css" rel="stylesheet"><?php endif; ?>
</head>
<body>
...
<main class="<?php if (!$isAnotherPage): ?>container<?php endif; ?>"><?= $content; ?></main>
</div>
